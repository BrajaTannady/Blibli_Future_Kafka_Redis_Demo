...
public class BookController {
  ...
  public Response<BookResponse> create(@RequestBody CreateBookRequest createBookRequest) {
    Book newBook = bookService.create(createBookRequest);
  ...
  public Response<BookResponse> update(@PathVariable String id,
    ...
    Book book = bookService.update(id, updateBookRequest);
    BookResponse bookResponse = convertToResponse(book);
    return Response.<BookResponse>builder()
        .status(HttpStatus.OK.value())
        .data(bookResponse)
